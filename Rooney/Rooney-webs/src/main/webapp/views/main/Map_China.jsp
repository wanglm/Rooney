...
<script src="commons/js/jquery/jquery-1.11.2.min.js"></script>
<script src="commons/js/plugins/bootstrap-3.3.0/js/bootstrap.min.js"></script>
<script src="commons/js/plugins/highmap-1.1.5//js/highmaps.js"></script> 
...
$.getJSON('commons/js/plugins/highmap-1.1.5/cn-all-sar-taiwan.geo.json',
				function(json) {
					$("#hc-map").highcharts(
									'Map',
									{
